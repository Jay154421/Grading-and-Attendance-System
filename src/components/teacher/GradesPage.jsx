        ...
        <div>
          <div className="mb-4">
            <div className="flex border-b border-red-100">
              <button
                className={`py-2 px-4 ${
                  activeTab === "raw" ? "border-b-2 border-red-600 font-medium" : "text-gray-500"
                }`}
              ...
              <button
                className={`py-2 px-4 ${
                  activeTab === "cumulative" ? "border-b-2 border-red-600 font-medium" : "text-gray-500"
                }`}
          ...
          {activeTab === "raw" && (
            <div className="bg-white rounded-lg border border-red-100 shadow-sm">
              <div className="p-4 border-b border-red-100">
                <h3 className="text-lg font-bold">Raw Grades</h3>
                      ...
                      <table className="w-full border-collapse">
                        <thead>
                          <tr className="border-b border-red-100">
                            ...
                            <th className="text-left p-2">Prelim</th>
                            <th className="text-left p-2">Midterm</th>
                            <th className="text-left p-2">Semi-Final</th>
                            ...
                            <tr key={student.id} className="border-b border-red-100 hover:bg-red-50">
                              ...
                              <td className="p-2">
                                <input
                                  ...
                                  className="w-20 px-3 py-2 border border-red-200 rounded-md"
                                />
                              </td>
                              <td className="p-2">
                                <input
          ...
          {activeTab === "cumulative" && (
            <div className="bg-white rounded-lg border border-red-100 shadow-sm">
              <div className="p-4 border-b border-red-100">
                <h3 className="text-lg font-bold">Cumulative Grades</h3>
                <p className="text-sm text-gray-500 mt-1">
                  {subjects.find(s => s.id === selectedSubject)?.name}
                  <span className="ml-2 text-red-600">
                    ({studentsInSubject.length} students)
